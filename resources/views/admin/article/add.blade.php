        ...
        <form class="layui-form" id="art_form" action="{{ url('admin/article') }}" method="post">
          <div class="layui-form-item">
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <img src="" id="art_thumb_img" style="max-width: 350px; max-height:100px;" alt="">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea placeholder="请输入内容" class="layui-textarea input_width" name="art_description"></textarea>
                </div>
            </div>
            <div class="layui-form-item">
                <label for="L_art_tag" class="layui-form-label">
                ...
                <div class="layui-input-block">
                    ...
                    {{--编辑器容器--}}
                    <script id="editor" type="text/plain" name="art_content" style="width:600px;height:300px;">
                    </script>
                ...
                {{--<div class="layui-tab">--}}
                    ...
                    {{--<div class="layui-tab-content">--}}
                        {{--<div class="layui-tab-item layui-show" >--}}
                            {{--<textarea id="z-textarea" placeholder="请输入内容" class="layui-textarea" name="art_description1"></textarea>--}}
                        {{--</div>--}}
                        {{--<div class="layui-tab-item">--}}
                            {{--<textarea id="z-textarea-preview" name="art_content" placeholder="请输入内容" class="layui-textarea"></textarea>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--</div>--}}
            {{--</div>--}}
